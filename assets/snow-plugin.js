...
(function ($) {
  ...
  (Snow.prototype.init = function (element) {
    ...
    (Snow.prototype.resetFlake = function (flake) {
      if (new Date().getTime() - curDate > 7 * 1000) {
        return false
      }
      if (0 == this.settings.windPower || 0 == this.settings.windPower) {
        ...
        var xarray = [Math.floor(Math.random() * this.canvas.width), 0],
          yarray = [0, Math.floor(Math.random() * this.canvas.height)],
          allarray = [xarray, yarray],
        ...
        flake.speed = (Math.floor(100 * Math.random()) % this.settings.speed) + (Math.random() * flake.size) / 10 + 0.5;
  ...
  $.fn.snow = function () {
    ...
    if (!userCanvas) {
      ...
      $(this).each(function (i, e) {
        setting["image"] =
          $(e).attr("image") ||
          "https://cdn.shopify.com/s/files/1/0550/0524/9633/files/959ed994ad153376c24d9eee9d464df3.png?v=1702432755";
        $(this).remove();
        createSnow("", 40);
      });
    }
